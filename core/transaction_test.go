...
func TestSign(t *testing.T) {
	...
	*/
	//test same key
	priv, pub := btcec.PrivKeyFromBytes(btcec.S256(), common.FromHex("0xe68fb0a479c495910c8351c3593667028b45d679f55ce22b0514c4a8a6bcbdd1"))
	assert.Equal(t, common.FromHex("0x036407c079c962872d0ddadc121affba13090d99a9739e0d602ccfda2dab5b63c0"), pub.SerializeCompressed(), "")
	assert.Equal(t, common.FromHex("0xe68fb0a479c495910c8351c3593667028b45d679f55ce22b0514c4a8a6bcbdd1"), priv.Serialize(), "")
